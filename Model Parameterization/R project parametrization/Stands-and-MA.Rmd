...
plot(Resistence, main = "Figure 9: Buffer zone and management ")
...
This way, the cells in question have a code that is no longer the old one and that is different depending of it is in the resistent area or the buffer zone.
